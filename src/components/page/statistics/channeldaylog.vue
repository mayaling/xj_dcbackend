<template>
            ...
            <div class="container">
                ...
                <div class="mgb20">
                        ...
                        <!-- <el-button type="primary" icon="el-icon-download"  @click="download()">下载</el-button> -->
                                <a :href="'http://api-backend.loan.xykj1.com/channel-analysis/get-data-ago?start_time='+time[0]+'&end_time='+time[1]" target="_blank">
    ...
    export default {
        ...
        methods: {
            ...
            // godownload(){
            //     window.location.href = "http://api-backend.loan.xykj1.com/channel-analysis/get-data-ago?"+this.time?this.time[0]:''&this.time?this.time[1]:''
            // },
            open() {
                this.$prompt('请输入充值金额', '', {
