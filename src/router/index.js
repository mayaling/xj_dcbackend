    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                ...
                {
                    path: '/linechart',
                    component: resolve => require(['../components/page/manageuser/user/linechart.vue'], resolve),
                    meta: { title: '测试', admin: true }
                },{
                    path: '/active',
                    ...
                    path: '/adduser',
                    component: resolve => require(['../components/page/product/adduser.vue'], resolve),
                    meta: { title: '产品列表', admin: true }
                },
                {
                    path: '/addproduct',
                ...
                {
                    path: '/adddproductadddeduct',
                    component: resolve => require(['../components/page/product/adddproductadddeduct.vue'], resolve),
                    meta: { title: '新增流量扣除', admin: true }
                },  {
                    path: '/undercarriage',
                    component: resolve => require(['../components/page/product/undercarriage.vue'], resolve),
                    meta: { title: '定量下架', admin: true }
                },{
                    path: '/productdata',
                    component: resolve => require(['../components/page/product/productdata.vue'], resolve),
                    meta: { title: '商户', admin: true }
                }, {
                    path: '/canaluser',
                    ...
                    path: '/productdaystatics',
                    component: resolve => require(['../components/page/statistics/productdaystatics.vue'], resolve),
                    meta: { title: '产品当日统计', admin: true }
                }, {
                ...
                },
                {
                    ...
                    path: '/dcbanner',
                    component: resolve => require(['../components/page/app/dcbanner.vue'], resolve),
                    meta: { title: '贷超banner', admin: true }
                },{
                    path: '/editdcbanner',
                    component: resolve => require(['../components/page/app/editdcbanner.vue'], resolve),
                    meta: { title: '编辑贷超banner', admin: true }
                },{
                    path: '/manageversion',
        ...
        {
            path: '/test',
            component: resolve => require(['../components/page/manageuser/user/test.vue'], resolve),
            meta: { title: 'CPA', admin: true }
        },
        {
            path: '/404',
